...
public class ExportSrdox2 extends SvrProcess {
	...
	protected String doIt() throws Exception {
		int count = DB.getSQLValue(get_TrxName(), "Select count(1) from DU_VolLine_V_SRDOCS_BR where du_vol_id=?", m_DU_Vol_ID);
		if (count <= 0 )
	...
	private ArrayList<Object[]> getTableData() {
		...
		String sql="Select * from DU_VolLine_V_SRDOCS_BR where du_vol_id = " + m_DU_Vol_ID + " Order By bpname";
