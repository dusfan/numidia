...
/** Generated Model for I_InvoicePurchase
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_I_InvoicePurchase extends PO implements I_I_InvoicePurchase, I_Persistent 
{
    ...
    {
      super (ctx, I_InvoicePurchase_ID, trxName);
      /** if (I_InvoicePurchase_ID == 0)
        {
			setI_InvoicePurchase_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_I_InvoicePurchase (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_InvoicePurchase[")
	...
	/** Set Import Purchase Invoice Booking.
		@param I_InvoicePurchase_ID Import Purchase Invoice Booking	  */
	public void setI_InvoicePurchase_ID (int I_InvoicePurchase_ID)
	{
		if (I_InvoicePurchase_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_InvoicePurchase_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_InvoicePurchase_ID, Integer.valueOf(I_InvoicePurchase_ID));
	}

	/** Get Import Purchase Invoice Booking.
		@return Import Purchase Invoice Booking	  */
	public int getI_InvoicePurchase_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_InvoicePurchase_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set I_InvoicePurchase_UU.
		@param I_InvoicePurchase_UU I_InvoicePurchase_UU	  */
	public void setI_InvoicePurchase_UU (String I_InvoicePurchase_UU)
	{
		set_Value (COLUMNNAME_I_InvoicePurchase_UU, I_InvoicePurchase_UU);
	}

	/** Get I_InvoicePurchase_UU.
		@return I_InvoicePurchase_UU	  */
	public String getI_InvoicePurchase_UU () 
	{
		return (String)get_Value(COLUMNNAME_I_InvoicePurchase_UU);
	}
