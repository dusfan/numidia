...
/** Generated Model for DU_VAllocationLine
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_DU_VAllocationLine extends PO implements I_DU_VAllocationLine, I_Persistent 
{
    ...
    public X_DU_VAllocationLine (Properties ctx, int DU_VAllocationLine_ID, String trxName)
    {
      super (ctx, DU_VAllocationLine_ID, trxName);
      /** if (DU_VAllocationLine_ID == 0)
        {
			setDU_VAllocationLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_DU_VAllocationLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DU_VAllocationLine[")
	...
	public I_DU_VAllocation getDU_VAllocation() throws RuntimeException
    {
		return (I_DU_VAllocation)MTable.get(getCtx(), I_DU_VAllocation.Table_Name)
			.getPO(getDU_VAllocation_ID(), get_TrxName());	}
	...
	/** Set Lignes d'affectation.
		@param DU_VAllocationLine_ID Lignes d'affectation	  */
	public void setDU_VAllocationLine_ID (int DU_VAllocationLine_ID)
	{
		if (DU_VAllocationLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DU_VAllocationLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DU_VAllocationLine_ID, Integer.valueOf(DU_VAllocationLine_ID));
	}

	/** Get Lignes d'affectation.
		@return Lignes d'affectation	  */
	public int getDU_VAllocationLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DU_VAllocationLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set DU_VAllocationLine_UU.
		@param DU_VAllocationLine_UU DU_VAllocationLine_UU	  */
	public void setDU_VAllocationLine_UU (String DU_VAllocationLine_UU)
	{
		set_Value (COLUMNNAME_DU_VAllocationLine_UU, DU_VAllocationLine_UU);
	}

	/** Get DU_VAllocationLine_UU.
		@return DU_VAllocationLine_UU	  */
	public String getDU_VAllocationLine_UU () 
	{
		return (String)get_Value(COLUMNNAME_DU_VAllocationLine_UU);
	}
	...
	public I_DU_VolLine getDU_VolLine() throws RuntimeException
    {
		return (I_DU_VolLine)MTable.get(getCtx(), I_DU_VolLine.Table_Name)
			.getPO(getDU_VolLine_ID(), get_TrxName());	}
	...
	{
		if (DU_VolLine_ID < 1) 
			set_Value (COLUMNNAME_DU_VolLine_ID, null);
		else 
			set_Value (COLUMNNAME_DU_VolLine_ID, Integer.valueOf(DU_VolLine_ID));
	}
