...
/** Generated Model for DU_IOrderAgence
 *  @author iDempiere (generated) 
 *  @version Release 4.1 - $Id$ */
public class X_DU_IOrderAgence extends PO implements I_DU_IOrderAgence, I_Persistent 
{
    ...
    public X_DU_IOrderAgence (Properties ctx, int DU_IOrderAgence_ID, String trxName)
    {
      super (ctx, DU_IOrderAgence_ID, trxName);
      /** if (DU_IOrderAgence_ID == 0)
        {
			setDU_IOrderAgence_ID (0);
        } */
    }

    /** Load Constructor */
    public X_DU_IOrderAgence (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DU_IOrderAgence[")
	...
	/** Set Validation Article Agence.
		@param DU_IOrderAgence_ID Validation Article Agence	  */
	public void setDU_IOrderAgence_ID (int DU_IOrderAgence_ID)
	{
		if (DU_IOrderAgence_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DU_IOrderAgence_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DU_IOrderAgence_ID, Integer.valueOf(DU_IOrderAgence_ID));
	}

	/** Get Validation Article Agence.
		@return Validation Article Agence	  */
	public int getDU_IOrderAgence_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DU_IOrderAgence_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
