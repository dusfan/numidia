...
/** Generated Interface for I_InvoiceBooking
 *  @author iDempiere (generated) 
 *  @version Release 4.1
 */
@SuppressWarnings("all")
public interface I_I_InvoiceBooking 
{

    /** TableName=I_InvoiceBooking */
    public static final String Table_Name = "I_InvoiceBooking";
    ...
    /** Column name Agency */
    public static final String COLUMNNAME_Agency = "Agency";
    ...
    public static final String COLUMNNAME_BookingDate = "BookingDate";
    ...
    /** Column name CancelDeadline */
    public static final String COLUMNNAME_CancelDeadline = "CancelDeadline";
    ...
    /** Column name I_InvoiceBooking_ID */
    public static final String COLUMNNAME_I_InvoiceBooking_ID = "I_InvoiceBooking_ID";
    ...
    /** Column name I_InvoiceBooking_UU */
    public static final String COLUMNNAME_I_InvoiceBooking_UU = "I_InvoiceBooking_UU";
    ...
    /** Column name ProductCancellationDeadline */
    public static final String COLUMNNAME_ProductCancellationDeadline = "ProductCancellationDeadline";
    ...
    /** Column name ProductTravelDates */
    public static final String COLUMNNAME_ProductTravelDates = "ProductTravelDates";
    ...
    /** Column name Staff */
    public static final String COLUMNNAME_Staff = "Staff";
    ...
    /** Column name Statut */
    public static final String COLUMNNAME_Statut = "Statut";
